...
void DatabaseWidget::copyTotp()
{
    ...
    setClipboardTextAndMinimize(currentEntry->totp(), PmpAuditLog::FldTotp);
}
...
void DatabaseWidget::setClipboardTextAndMinimize(const QString& text, int pmpField)
{
    clipboard()->setText(text);
    PmpAuditLog::instance()->record(PmpAuditLog::EvCopy, PmpAuditLog::OcSuccess,
                                    static_cast<PmpAuditLog::Field>(pmpField),
